...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ---------- Admission form (front-end only demo) ---------- */
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      btn.textContent = 'ধন্যবাদ! আবেদন গ্রহণ করা হয়েছে ✓';
      btn.disabled = true;
      setTimeout(() => {
  ...
  const answers = {
    admission: 'ভর্তি প্রক্রিয়া সম্পূর্ণ অনলাইনে: ফর্ম পূরণ → ডকুমেন্ট আপলোড → নিশ্চিতকরণ → ভর্তি সম্পন্ন। নিচের "Apply Online" বাটনে গিয়ে শুরু করতে পারেন।',
  ...
  /* close mega menus / AI panel on outside click for touch devices */
  document.addEventListener('click', (e) => {
    if (!document.getElementById('aiWidget').contains(e.target)) closeAi();
  });
});
